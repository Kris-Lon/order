...
file = "/home/strateg-ai/order_scripts/xlsx_files/Отчет_№18_Ежемесячный_отчет_о_цикличности_поставок_и_сроки_между_ними_по_всем_товарам_работам_и_услугам_за_1_месяц_от_{}.xlsx".format(today.isoformat())
...
writer.save()
send_mail(send_from="report@emsoft.ru", send_to=["report@emsoft.ru", "kaloria@mail.ru"], subject="Отчет №18", text="Отчёт о цикличности поставок и сроки между ними по всем товарам, работам и услугам за 1 месяц от {} \n\nС уважением,\nООО \"Эмсофт\"\n+7 (495) 230-23-48\nreport@emsoft.ru\n".format(today.isoformat()), files=file)
